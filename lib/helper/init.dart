...
import '../backend/parse/add_address_parse.dart';
import '../backend/parse/add_product_review_parse.dart';
import '../backend/parse/add_review_parse.dart';
...
import '../backend/parse/appointment_detail_parse.dart';
import '../backend/parse/booking_parse.dart';
import '../backend/parse/cart_parse.dart';
import '../backend/parse/category_parse.dart';
import '../backend/parse/chat_parse.dart';
import '../backend/parse/checkout_parse.dart';
import '../backend/parse/choose_location_parse.dart';
import '../backend/parse/complaints_parse.dart';
import '../backend/parse/contactus_parse.dart';
import '../backend/parse/coupens_parse.dart';
import '../backend/parse/edit_profile_parse.dart';
import '../backend/parse/favorite_parse.dart';
import '../backend/parse/filter_parse.dart';
import '../backend/parse/find_location_parse.dart';
import '../backend/parse/firebase_parse.dart';
import '../backend/parse/forgot_password_parse.dart';
import '../backend/parse/freelancer_product_parse.dart';
import '../backend/parse/handyman_profile_parse.dart';
import '../backend/parse/history_parse.dart';
import '../backend/parse/home_parse.dart';
import '../backend/parse/inbox_parse.dart';
...
import '../backend/parse/product_cart_parse.dart';
import '../backend/parse/product_category_parse.dart';
import '../backend/parse/product_checkout_parse.dart';
import '../backend/parse/product_detail_parse.dart';
import '../backend/parse/product_history_parse.dart';
import '../backend/parse/product_listing_parse.dart';
import '../backend/parse/product_order_detail_parse.dart';
import '../backend/parse/refer_parse.dart';
import '../backend/parse/register_parse.dart';
import '../backend/parse/search_parse.dart';
import '../backend/parse/service_detail_parse.dart';
import '../backend/parse/services_parse.dart';
import '../backend/parse/single_product_review_parse.dart';
import '../backend/parse/slider_parse.dart';
...
import '../backend/parse/wallet_parse.dart';
import '../backend/parse/web_payment_parse.dart';
import '../backend/parse/web_payment_product_parse.dart';
