                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    value.freelancerDetail.verified == 1 ? const CircleAvatar(radius: 8, backgroundColor: ThemeProvider.appColor, child: Icon(Icons.done, size: 10, color: Colors.white)) : const SizedBox()
                                  ],
                                ),
                                ...
                                const SizedBox(height: 10),
                                Text(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.freelancerDetail.hourlyPrice}/${'hr'.tr}' : '${value.freelancerDetail.hourlyPrice}${value.currencySymbol}/${'hr'.tr}',
