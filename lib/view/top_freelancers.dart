...
import '../controller/top_freelancers_controller.dart';
import '../env.dart';
import '../util/theme.dart';

class TopFreelancerScreen extends StatefulWidget {
  const TopFreelancerScreen({super.key});
...
class _TopFreelancerScreenState extends State<TopFreelancerScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TopFreelancersController>(
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            centerTitle: true,
            title: Text('Top Freelancers'.tr, style: ThemeProvider.titleStyle),
          ),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 6),
                                          Text(
                                            value.currencySide == 'left' ? '${value.currencySymbol}${value.freelancerList[i].hourlyPrice}/hr' : '${value.freelancerList[i].hourlyPrice}${value.currencySymbol}/hr',
                                            textAlign: TextAlign.center,
