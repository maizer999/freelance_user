...
import '../controller/appointment_detail_controller.dart';
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [const Icon(Icons.call, size: 14, color: ThemeProvider.greyColor), const SizedBox(width: 4), smallBoldText(value.appointmentDetail.freelancer?.mobile.toString())],
                                      ),
                                    ],
                                  ),
                                ),
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                smallBoldText(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.appointmentDetail.walletPrice.toString()}' : '${value.appointmentDetail.walletPrice.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
