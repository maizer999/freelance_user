                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    Text(
                                                      value.currencySide == 'left' ? '${value.currencySymbol}${value.relatedProductsList[i].originalPrice}' : '${value.relatedProductsList[i].originalPrice}${value.currencySymbol}',
                                                      style: const TextStyle(decoration: TextDecoration.lineThrough, color: ThemeProvider.greyColor, fontSize: 12),
                                                    ),
                                                    const SizedBox(width: 16),
                                                    Text(
                                                      value.currencySide == 'left' ? '${value.currencySymbol}${value.relatedProductsList[i].sellPrice}' : '${value.relatedProductsList[i].sellPrice}${value.currencySymbol}',
