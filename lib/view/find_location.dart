            ...
            child: Column(
              children: [
                ...
                value.getList.isEmpty
                    ? TextButton(onPressed: () => value.getLocation(), child: Text('Use My Current Location'.tr.toUpperCase(), style: const TextStyle(color: ThemeProvider.appColor, letterSpacing: 1.1)))
                    : const SizedBox(),
