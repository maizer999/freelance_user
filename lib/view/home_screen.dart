                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [heading2('Products'.tr), MyTextButton(onPressed: () => Get.toNamed(AppRouter.getPopularProductRoute()), text: 'See All'.tr, colors: ThemeProvider.greyColor)],
                              ),
                            ),
                            SingleChildScrollView(
                              scrollDirection: Axis.horizontal,
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          value.currencySide == 'left' ? '${value.currencySymbol}${value.productList[i].originalPrice}' : '${value.productList[i].originalPrice}${value.currencySymbol}',
                                                          style: const TextStyle(decoration: TextDecoration.lineThrough, color: ThemeProvider.greyColor, fontSize: 12),
                                                        ),
                                                        Text(
                                                          value.currencySide == 'left' ? '${value.currencySymbol}${value.productList[i].sellPrice}' : '${value.productList[i].sellPrice}${value.currencySymbol}',
