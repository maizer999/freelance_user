                      ...
                      children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [heading4(value.freelancerDetail.name.toString()), const SizedBox(height: 4), smallText('${value.freelancerDetail.totalExperience} ${'year experience'.tr}')],
                                ),
                              ),
                            ],
                          ),
                        ...
                        Card(
                          child: ListTile(
                            ...
                            title: value.currencySide == 'left' ? Text('${'Available Balance'.tr + value.currencySymbol}${value.balance}') : Text('${'Available Balance'.tr + value.balance.toString()}${value.currencySymbol}'),
                            onTap: () {},
                          ),
                        ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  bodyText1(
                                    value.currencySide == 'left' ? '${value.currencySymbol}${Get.find<CartController>().totalPrice.toString()}' : '${Get.find<CartController>().totalPrice.toString()}${value.currencySymbol}',
                                  ),
                                ],
                              ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  bodyText1(
                                    value.currencySide == 'left' ? '${value.currencySymbol}${Get.find<CartController>().orderTax.toString()}' : '${Get.find<CartController>().orderTax.toString()}${value.currencySymbol}',
                                  ),
                                ],
                              ),
