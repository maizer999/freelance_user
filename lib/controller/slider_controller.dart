...
import '../backend/model/slider_model.dart';
...
class SliderController extends GetxController implements GetxService {
  ...
  List<Item> imgList = const <Item>[
    Item('assets/images/bob.gif', 'Welcome to Handyman', 'In publishing and graphic design lorem ipsum is a filler text commonly used to demonstrate.'),
