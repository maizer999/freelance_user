...
class AddAddressController extends GetxController implements GetxService {
  ...
  Future<void> updateAddress() async {
    var body = {"title": title, "address": addressTextEditor.text, "house": houseTextEditor.text, "landmark": landmarkTextEditor.text, "pincode": zipcodeTextEditor.text, "lat": lat, "lng": lng, "id": addressId};
