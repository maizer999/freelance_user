...
class FreelancerProductParser {
  ...
  FreelancerProductParser({required this.sharedPreferencesManager, required this.apiService});

  Future<Response> getFreelancerProducts(var body) async {
    var response = await apiService.postPublic(AppConstants.getFreelancerProducts, body);
    return response;
  }
